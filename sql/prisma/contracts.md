---
url: https://alchemy.run/sql/prisma/contracts
title: "Contracts"
description: "Author Prisma ORM v8 contracts in Prisma Schema Language or TypeScript, generate optional Effect bindings and row schemas, and connect them to migrations."
...
[Alchemy migration resources](migrations.md).
...
breaking changes between release candidates. See [Postgres](postgres.md)
for dependencies and the client API, or the [Cloudflare integration](../../cloudflare/data/prisma.md)
...
The [Cloudflare integration](../../cloudflare/data/prisma.md) shows Hyperdrive wiring.
...
from tree-shaking. Follow [Configure validation for Workers](../../cloudflare/data/prisma.md#configure-validation-for-workers).
...
the database. Follow [Migrations](migrations.md) to review and apply
schema changes, including changes that need an explicit data backfill.

## Where next

- [Postgres](postgres.md) — queries, prepared statements, and transactions.
- [Cloudflare integration](../../cloudflare/data/prisma.md) — provision a database and query it from a Worker.
- [SQL databases](../databases.md) — database choices and canonical deployment guides.
- [Migrations](migrations.md) — plan and apply contract changes on deployment.
