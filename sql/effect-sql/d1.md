...
see [Connection lifecycle](lifecycle.md).
...
[`SQL.PostgresLayer`](postgres.md#provide-as-a-service)
...
- [Migrations](migrations.md) — apply `.sql` files as
  part of deploy.
- [Connection lifecycle](lifecycle.md) — when the
  client is built and torn down.
- [Drizzle on D1](../drizzle/d1.md) — the same driver behind a typed
  schema.
- [D1](../../cloudflare/data/d1.md) — the database resource: replication,
