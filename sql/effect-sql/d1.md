...
[Cloudflare setup](../../cloudflare/setup.md) and [D1](../../cloudflare/data/d1.md) cover deployment and database behavior; [SQL databases](../databases.md) compares D1 with other engines. Read [Migrations](migrations.md) for committed SQL application, [Connection lifecycle](lifecycle.md) for cleanup, or [Drizzle on D1](../drizzle/d1.md) for typed schemas.
