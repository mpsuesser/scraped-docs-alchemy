...
## Declare the send\_email binding
...
Bind the descriptor with `Email.Send` in the Worker’s Construction phase and provide `Email.SendBinding` as the implementation layer:
