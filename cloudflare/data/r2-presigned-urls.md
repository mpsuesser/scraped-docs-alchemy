...
[R2 bucket](r2.md) directly, without credentials. Your
...
- [R2](r2.md)
- [Local development](https://alchemy.run/cloudflare/local-development)
- [R2 API reference](https://alchemy.run/providers/cloudflare/r2)
