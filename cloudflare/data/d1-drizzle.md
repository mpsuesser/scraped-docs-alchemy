...
D1 applies pending SQL during deployment. [D1 migrations](d1.md#migrations) covers database-specific behavior; [Drizzle migrations](../../sql/drizzle/migrations.md) covers file generation.
...
[Drizzle on D1](../../sql/drizzle/d1.md) covers relational queries; [Effect SQL on D1](../../sql/effect-sql/d1.md) covers tagged-template SQL. D1 uses batch operations rather than interactive transactions or streaming queries.

## Where next

See [SQL databases](../../sql/databases.md), the [D1 resource](d1.md), or the [existing D1 example](https://github.com/alchemy-run/alchemy/tree/main/examples/cloudflare-d1-drizzle).
