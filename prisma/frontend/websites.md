...
it to [Prisma Compute](../compute/apps.md). The shared
...
| Hugo, Zola, or any static generator | `StaticSite` | [Static sites](static-site.md) |
...
[Set up Prisma credentials](../setup.md) for live deployments. Install
...
[Connection](../data/connections.md) and pass its outputs explicitly.
...
[Compute custom domains](../compute/apps.md#custom-domains).

## Where next

- [Vite](vite.md) — client builds, SPA routing, and env inlining.
- [Astro](astro.md) — SSR and fully static sites.
- [Static sites](static-site.md) — build commands and 404 handling.
- [Compute apps](../compute/apps.md) — lower-level builds and Effect-native services.
- [Deployments](../compute/deployments.md) — upload, health checks, and promotion.
- [Postgres](../data/postgres.md) and [Connections](../data/connections.md).
