---
url: https://alchemy.run/prisma/data/drizzle-postgres
title: "Drizzle Postgres on Prisma Compute"
description: "Use Alchemy's Prisma hosting provider to run a Drizzle API against Prisma Postgres."
access_date: 2026-09-24T22:45:48.980Z
current_date: 2026-09-24T22:45:48.980Z
---

Prisma here means Alchemy’s Prisma hosting and database provider, not Prisma ORM. Complete [Prisma setup](../setup.md), start from the [prisma-compute-effect example](https://github.com/alchemy-run/alchemy/tree/main/examples/prisma-compute-effect), and add a `src/schema.ts` exporting `Users` from the [Postgres client guide](../../sql/drizzle/postgres.md).
...
The starter’s `src/Database.ts` creates an explicit [Prisma Postgres database](postgres.md) rather than relying on the project’s default database:
...
This is the starter’s [connection resource](connections.md); its redacted outputs include direct and pooled URLs when available.
...
See the [Prisma Postgres guide](postgres.md), [Compute deployment guide](../compute/apps.md), [portable Postgres queries](../../sql/drizzle/postgres.md), and [migration workflow](../../sql/drizzle/migrations.md). The [Prisma tutorial example](https://github.com/alchemy-run/alchemy/tree/main/examples/prisma-tutorial) exercises the same Postgres driver through `SQL.Postgres` in Compute.
