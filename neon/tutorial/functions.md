---
url: https://alchemy.run/neon/tutorial/functions
title: "Protect and process uploads"
description: "Verify JWTs, sign private uploads, and record real bucket events in Postgres."
...
Continue with the [browser frontend](frontend.md).
