---
url: https://alchemy.run/neon/guides/custom-domains
title: "Custom domains"
description: "Register a Function hostname, configure DNS and CAA, verify HTTPS, and retire the domain safely."
...
certificate provisioning complete the setup. Start with [Setup](../setup.md) and
...
[Production Auth](production-auth.md).
...
[State and recovery](state-recovery.md).

## Related guides

- [CustomDomain reference](https://alchemy.run/providers/neon/reference/function#customdomain) — inputs, outputs, and lifecycle.
- [Neon custom domains](https://neon.com/docs/compute/functions/custom-domains) — current DNS, CAA, and status behavior.
- [Setup](../setup.md) — deployment prerequisites.
