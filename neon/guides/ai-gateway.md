...
access. Complete [Setup](../setup.md) first.
...
billing. See the [resource reference](https://alchemy.run/providers/neon/reference/ai-gateway#aigateway) for explicit
...
[AI Gateway bindings](https://alchemy.run/providers/neon/reference/ai-gateway#queryaigateway) and the
[Effect model layer](https://alchemy.run/providers/neon/reference/ai-gateway#makelanguagemodellayer).
...
- [Setup](../setup.md) — management credentials and feature prerequisites.
- [Private networking](private-networking.md) — database-only network controls.
- [State and recovery](state-recovery.md) — retain managed credential state.
