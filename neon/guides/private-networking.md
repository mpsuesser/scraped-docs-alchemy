---
url: https://alchemy.run/neon/guides/private-networking
title: "Private networking"
description: "Prepare AWS PrivateLink endpoints, register them with Neon, enable private DNS, and verify database access."
...
or block public connections. Complete [Setup](../setup.md) and review
[governance ownership](../governance.md) before changing a shared network.
...
- [Organization governance](../governance.md) — IDs, permissions, adoption, and restoration.
- [State and recovery](state-recovery.md) — interrupted operations and retained state.
