---
url: https://alchemy.run/neon/guides/state-recovery
title: "State and recovery"
description: "Preserve Neon ownership and reveal-once secrets, recover interrupted deployments, and clean up without discarding state."
...
a disposable build cache. Complete [Setup](../setup.md) and choose a durable
[state store](../../state-store.md) before deploying production resources.
...
- Remove custom-domain DNS records and allow them to expire before releasing the
  registration; see [Custom domains](custom-domains.md#retire-the-hostname).
- Remove project endpoint associations before an owned organization endpoint
  ...
  organization; see [Private networking](private-networking.md).
...
- [State stores](../../state-store.md) — backend selection.
- [Organization governance](../governance.md) — restoration and adoption rules.
- [Preview cleanup](../tutorial/previews.md) — tutorial-specific destruction commands.
- [Setup](../setup.md) — profiles and environment credential precedence.
