---
url: https://alchemy.run/neon/governance
title: "Organization governance"
description: "Manage existing Neon organization access, billing alerts, and private-network associations with explicit ownership and restoration."
...
| --- | --- | --- |
| [OrganizationApiKey](https://alchemy.run/providers/neon/reference/organization#organizationapikey) | An organization key, optionally project-restricted | Revoke the exact recorded key |
| [OrganizationMemberRole](https://alchemy.run/providers/neon/reference/organization#organizationmemberrole) | An existing member's organization role | Restore their original role, never remove membership |
| [ProjectMemberRole](https://alchemy.run/providers/neon/reference/project#projectmemberrole) | An existing member's direct project grant | Restore the original direct grant, or remove the new grant |
| [OrganizationSpendingLimit](https://alchemy.run/providers/neon/reference/organization#organizationspendinglimit) | Monthly spending-alert threshold | Restore the original threshold, or remove the new threshold |
| [OrganizationVPCEndpoint](https://alchemy.run/providers/neon/reference/organization#organizationvpcendpoint) | Registration of an existing AWS PrivateLink endpoint | Restore an adopted label, or unregister a new registration |
| [ProjectVPCEndpoint](https://alchemy.run/providers/neon/reference/project#projectvpcendpoint) | A project's association with an organization endpoint | Restore an adopted label, or remove a new association |
...
key using [Setup](setup.md), never as a Function environment variable.
...
[`Neon.Credential`](https://alchemy.run/providers/neon/reference/credential#credential) and the runtime bindings instead;
...
supported AWS region. Follow [Private networking](guides/private-networking.md)
...
[State and recovery](guides/state-recovery.md) before another mutation.
