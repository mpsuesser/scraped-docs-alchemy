...
- [Lambda](../compute/lambda.md) — the runtime that sends.
- [Email receiving](receiving.md) — the inbound side: SES
  receipt rules into S3, SNS, and Lambda.
- [CloudWatch](../observability/cloudwatch.md) — alarm on bounce and
  complaint metrics.
