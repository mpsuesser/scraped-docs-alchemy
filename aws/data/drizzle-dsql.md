---
url: https://alchemy.run/aws/data/drizzle-dsql
title: "Drizzle + Aurora DSQL"
description: "Drizzle on Lambda with Aurora DSQL, a non-admin database role, verified TLS, and an explicit DSQL migration boundary."
access_date: 2026-09-24T22:45:48.980Z
current_date: 2026-09-24T22:45:48.980Z
---

[Runnable example](https://github.com/alchemy-run/alchemy/tree/main/examples/aws-dsql-drizzle) · [AWS setup](../setup.md) · [Aurora PostgreSQL instead](drizzle-aurora.md)
...
DSQL provides the `postgres` database and a public PostgreSQL-wire endpoint authenticated through IAM; no VPC attachment or password secret is needed. It is not the Aurora cluster-and-writer topology. [DSQL cluster reference](https://alchemy.run/providers/aws/dsql#cluster) · [SQL databases](../../sql/databases.md).
...
[Drizzle query API](../../sql/drizzle/postgres.md)
...
[Frontend + RPC](../frontend/full-stack-tanstack-rpc-drizzle.md) · [Aurora PostgreSQL](drizzle-aurora.md) · [SQL databases](../../sql/databases.md)
