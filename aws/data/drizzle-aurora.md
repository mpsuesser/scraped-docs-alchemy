---
url: https://alchemy.run/aws/data/drizzle-aurora
title: "Drizzle + Aurora PostgreSQL"
description: "Drizzle on Lambda with private Aurora PostgreSQL, IAM authentication, verified TLS, and reviewed SQL migrations."
access_date: 2026-09-24T22:45:48.980Z
current_date: 2026-09-24T22:45:48.980Z
---

[Runnable example](https://github.com/alchemy-run/alchemy/tree/main/examples/aws-aurora-drizzle) · [AWS setup](../setup.md) · [Aurora DSQL instead](drizzle-dsql.md)
...
The example uses `us-west-2`, Aurora PostgreSQL 17.5, and Node.js 22. Change both subnet availability zones if you change region. Application queries use Effect-native Drizzle over `pg`, not the RDS Data API driver; [SQL databases](../../sql/databases.md) compares the integrations.
...
[Network setup](https://github.com/alchemy-run/alchemy/blob/main/examples/aws-aurora-drizzle/src/database.ts) allows port 5432 only from the Lambda's security group. [Aurora options](rds.md).
...
[Schema and queries](../../sql/drizzle/postgres.md) · [Connection lifecycle](../../sql/effect-sql/lifecycle.md)
...
[SQL databases](../../sql/databases.md) · [Aurora configuration](rds.md) · [Lambda](../compute/lambda.md)
