...
[Layer](layers.md) returns a service. Learn it
...
[Schemaless RPC](../apis/schemaless.md), the default for internal calls. The
[APIs](../apis.md) section adds the schema'd surfaces for trust boundaries.
...
other. See [Bindings](binding.md) for how they
work.
...
[SQL connection lifecycle](../sql/effect-sql/lifecycle.md) is the canonical
